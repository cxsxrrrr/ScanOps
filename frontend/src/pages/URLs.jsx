    ...
    return (
        <div className="space-y-6">
            ...
            <form onSubmit={handleAddUrl} className="glass rounded-xl p-6">
                ...
                <div className="flex gap-3">
                    <div className="flex-1 relative">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-2.5 rounded-lg bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all text-sm"
                            required
                        />
                    </div>
                    <button
                ...
                {error && (
                    <div className="mt-3 flex items-center gap-2 text-red-600 dark:text-red-400 text-sm bg-red-500/5 border border-red-500/10 p-3 rounded-lg">
                            ...
                            >
                                <div className="flex items-center gap-3 min-w-0 flex-1">
                                    ...
                                    <div className="min-w-0">
                                        <a
                                            ...
                                            className="text-sm font-medium hover:text-blue-500 transition-colors flex items-center gap-1 truncate"
                                        >
                                            {url.url}
                                ...
                                <div className="flex items-center gap-2 ml-4">
                                    <button
                                        ...
                                        className="px-3 py-1.5 rounded-lg bg-blue-500/10 text-blue-600 dark:text-blue-400 hover:bg-blue-500/20 transition-colors text-sm font-medium flex items-center gap-1.5 disabled:opacity-50"
                                    >
                                        {scanningId === url.id ? (
                                    ...
                                    {deleteConfirmId === url.id ? (
                                        <div className="flex items-center gap-1.5 animate-fade-in">
                                            ...
                                            <button
                                                ...
                                                className="px-2 py-1 rounded-md bg-red-500/20 text-red-600 dark:text-red-400 hover:bg-red-500/30 transition-colors text-xs font-medium"
                                            >
                                                Sí
                                            </button>
                                            <button
                                                onClick={() => setDeleteConfirmId(null)}
                                                className="px-2 py-1 rounded-md bg-gray-100 dark:bg-white/5 text-muted-foreground hover:bg-gray-200 dark:hover:bg-white/10 transition-colors text-xs font-medium"
                                            >
                                                No
                                            </button>
                                        </div>
